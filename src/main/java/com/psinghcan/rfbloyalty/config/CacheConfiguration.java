package com.psinghcan.rfbloyalty.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.psinghcan.rfbloyalty.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.psinghcan.rfbloyalty.repository.UserRepository.USERS_BY_EMAIL_CACHE);
